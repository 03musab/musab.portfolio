    ...
    <section id="education" className="scroll-mt-24 space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <Reveal className="lg:col-span-8">
          <motion.div
            {...cardHoverProps}
            className="h-full rounded-2xl border border-line bg-surface p-7 transition-colors hover:border-foreground/30 lg:rounded-3xl lg:p-8"
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <motion.div
                ...
                className="rounded-2xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-center cursor-default"
              >
        ...
        <Reveal className="lg:col-span-4" delay={0.1}>
          <motion.div
            {...cardHoverProps}
            className="flex h-full flex-col justify-between space-y-4 rounded-2xl border border-line bg-surface p-7 lg:rounded-3xl lg:p-8"
          >
            ...
            <div className="space-y-4">
              <motion.div
                whileHover={{ x: 2 }}
                className="flex items-center justify-between rounded-xl border border-line/60 bg-background/50 p-4"
              >
                <div>
